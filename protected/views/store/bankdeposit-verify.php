...
$this->renderPartial('/front/default-header',array(
   'h1'=>t("Deposito Bancario"),
   'sub_text'=>t("Comprovante de deposito")
));
...
<div class="sections section-grey2 section-orangeform">
  ...
  <h1><?php echo t("Verificacao de deposito Bancario")?></h1>
  ...
  <?php echo Yii::t("default","O nao fornecimento de informacoes precisas pode causar atrasos no processamento ou invalidacao do seu pagamento.")?>
  </p>
