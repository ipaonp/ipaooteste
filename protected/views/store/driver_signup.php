<?php
$this->renderPartial('/front/banner-motoboy',array(
   'h1'=>t("Cadastro de Motoboy"),
   'sub_text'=>t("Torne-se um de nossos entregadores")
));
         ...
         <div class="box-grey round top-line-green">
		   ...
		   <?php echo CHtml::hiddenField('action','driverSignup')?>
		     ...
		     <div class="row top10">
		      ...
		      <div class="row top10">
		        <div class="col-md-3 "><?php echo t("Tipo de transporte")?></div>
		        <div class="col-md-8 ">
		             <?php 
		      ...
		      <div class="row top10">
		        <div class="col-md-3 "><?php echo t("Descricao do Transporte (Ano,Modelo)")?></div>
		        <div class="col-md-8 ">
		      ...
		      <div class="row top10">
		        <div class="col-md-3 "><?php echo t("Placa")?></div>
		        <div class="col-md-8 ">
		      ...
		      <div class="row top10">
		        <div class="col-md-3 "><?php echo t("Cor")?></div>
		        <div class="col-md-8 ">
